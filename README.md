...
本棚で帳を選ぶと、まずその帳の表紙が開きます。自由帳は1〜12文字の名前と16色から選ぶ表紙色を指定し、「手帳を新しく作る」ボタンを押したときだけ作成されます。
...
新しい収集手帳では、記録の詳細頁にある「写真を選ぶ」から端末内の画像を選択します。スマホではGoogleフォトなどを含むOS標準の写真選択画面が開きます。画像は外部へアップロードされず、この端末の手帳内だけに保存されます。
